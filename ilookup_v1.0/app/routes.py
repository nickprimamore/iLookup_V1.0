...
def convertUnicodeToArray(unicodeArray):
	try:
		...
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: convertUnicodeToArray - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def load():
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: load - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def search():
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: search - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def update():
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: update - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def createTag():
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: createTag - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def deleteTag():
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: deleteTag - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def getTags():
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: getTags - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def result():
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: result - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def sendTasks():
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: sendTasks - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def sendClients():
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: sendClients - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def sendReleases():
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: sendReleases - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def updateReleaseTable():
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: updateReleaseTable - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def updateRelease(product_name=None, release_number=None, cluster_name=None):
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: updateRelease - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def mostRecentReleases():
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: mostRecentReleases - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def getTaskDefinitions(cluster_name, release_number):
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: getTaskDefinitions - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def fetchClientKeyValue(new_client_key, new_client_name, cluster_name, currentTags):
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: fetchClientKeyValue - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def getReleases(cluster_name):
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: getReleases - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def getClients(cluster_name, release_number):
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: getClients - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()
...
def loadAWSData():
	try:
		...
		date = datetime.utcnow()
		tb = sys.exc_info()[2]
		errorMsg = str(date) + " - File: routes.py - Function: loadAWSData - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
		f.write(errorMsg)
		f.close()

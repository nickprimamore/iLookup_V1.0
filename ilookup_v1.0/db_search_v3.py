...
class Search:
	...
	def convertUnicodeToArray(self,unicodeArray):
		try:
			...
			tb = sys.exc_info()[2]
			errorMsg = str(date) + " - File: db_search_v3.py - Function: convertUnicodeToArray - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
			f.write(errorMsg)
			f.close()
	...
	def getSearchResult(self,client_name=None, product_name=None, release=None, cluster_name=None, region=None, environment=None, toDate=None, fromDate=None, is_active=None):
		try:
			...
			date = datetime.utcnow()
			tb = sys.exc_info()[2]
			errorMsg = str(date) + " - File: db_search_v3.py - Function: getSearchResult - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
			f.write(errorMsg)
			f.close()
	...
	def getLatestReleases(self):
		try:
			...
			date = datetime.utcnow()
			tb = sys.exc_info()[2]
			errorMsg = str(date) + " - File: db_search_v3.py - Function: getLatestReleases - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
			f.write(errorMsg)
			f.close()
	...
	def getTaskDefinitions(self,cluster_name=None,release_number=None):
		try:
			...
			date = datetime.utcnow()
			tb = sys.exc_info()[2]
			errorMsg = str(date) + " - File: db_search_v3.py - Function: getTaskDefinitions - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
			f.write(errorMsg)
			f.close()
	...
	def getReleases(self, cluster_name=None):
		try:
			...
			date = datetime.utcnow()
			tb = sys.exc_info()[2]
			errorMsg = str(date) + " - File: db_search_v3.py - Function: getReleases - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
			f.write(errorMsg)
			f.close()
	...
	def getClients(self, cluster_name=None, release_number=None):
		try:
			...
			date = datetime.utcnow()
			tb = sys.exc_info()[2]
			errorMsg = str(date) + " - File: db_search_v3.py - Function: getClients - " + str(ex.args) + " - on line " + str(tb.tb_lineno) + " \r\n"
			f.write(errorMsg)
			f.close()
